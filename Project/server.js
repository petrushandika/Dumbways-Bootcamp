...
app.get("/add-blog", upload.single("image"), addBlogView);
...
async function addBlog(req, res) {
  try {
    ...
    const query = `INSERT INTO blogs(title, start, "end", duration, description, tech, image, "userId") VALUES ('${title}', '${start}', '${end}', '${duration()}', '${description}', '${techArray}' , 'https://media.istockphoto.com/id/1296158947/photo/portrait-of-creative-trendy-black-african-male-designer-laughing.jpg?s=612x612&w=0&k=20&c=1Ws_LSzWjYvegGxHYQkkgVytdpDcnmK0upJyGOzEPcg=', '${userId}')`;
